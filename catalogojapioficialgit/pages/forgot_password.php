<?php require '../assets/php/auth/login_check_false.php';?>
...
<head>
    ...
    <title>Catálogo JAPI - Esqueci a Senha</title>
                    ...
                    <div class="col-lg-8 col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="./auth.php?case=login">Entrar</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Esqueci a Senha</li>
                            </ol>
                        </nav>
                    <h2 class="text-white">Esqueci a Senha</h2>
                    <p class="text-white mt-3">Informe seu e-mail para enviarmos um código de recuperação.</p>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 mx-auto">
                        ...
                        <div class="form-floating mb-12">
                            <p>Enviaremos um código no e-mail para que você possa Redefinir a sua Senha! </p>
                        </div>
                            
                        <form action="../assets/php/login.php" method="post" class="custom-form contact-form" role="form">
                            <div class="form-floating mb-3">
                                <input type="email" name="useremail" maxlength="255" class="form-control" value="<?php echo htmlspecialchars($useremail); ?>" required>
                                <label>Email</label>
                            </div>

                            <button type="submit" class="form-control btn btn-primary">Enviar código de recuperação</button>
                        </form>
                    </div>
                </div>
            </div>
