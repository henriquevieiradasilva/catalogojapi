...
<head>
    ...
    <meta name="description" content="Confirmação de senha para editar os dados da conta no Catálogo JAPI.">
    <meta name="author" content="Equipe Catálogo JAPI">
    <title>Confirmar Senha - Catálogo JAPI</title>
                    ...
                    <div class="col-lg-6 col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="./account.php">Perfil</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Confirmar Senha</li>
                            </ol>
                        </nav>
                        <h2 class="text-white">Confirmar Edição</h2>
                        <p class="text-white mt-3">Digite sua senha atual para continuar.</p>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 mx-auto">
                        ...
                        <!-- ERROR ALERT -->
                        <div id="jsErrorContainer" class="col-12 col-lg-9 mx-auto">
                        ...
                        <div class="col-12 col-lg-10 mx-auto"> 
                            <form id="registerForm" action="../assets/php/account/update_password_check.php" method="post" enctype="multipart/form-data" class="custom-form contact-form" role="form">
                                <div class="row justify-content-center mb-3">
                                    <div class="col-md-10">
                                        <div class="form-floating">
                                            <input type="password" name="userpassword" id="userpassword" maxlength="30" class="form-control" required>
                                ...
                                <div class="row g-3 justify-content-center">
                                    <div class="col-12 col-md-4 d-grid">
                                        <a href="javascript:history.back()" class="btn custom-btn custom-border-btn">VOLTAR</a>
                                    </div>
