...
CREATE TABLE Posts (
    ...
    SensitiveContent BOOLEAN DEFAULT FALSE, -- TRUE ou FALSE
    Notes TEXT, 
...
CREATE TABLE Videos (
    PostID INT NOT NULL,
    VideoName VARCHAR(100) NOT NULL UNIQUE, -- Nome dos vídeos sempre serão diferentes, com o nome tendo o iddopost dia e horario do envio (ex: 01062025_163253_03.png)
